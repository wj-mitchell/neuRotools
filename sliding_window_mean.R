# Sliding_Window_Mean.R || v2023.11.15

Sliding_Window_Mean <- function(x,
                               window_size,
                               sigma = 3,
                               step_size = 1){
  ...
  if (any(!is.numeric(x))){
    stop("X must be numeric arrays of equal length. Please consider coercing or reformatting your values and try again")
  }
